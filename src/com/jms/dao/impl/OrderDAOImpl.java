...
public class OrderDAOImpl implements OrderDAO {
    ...
    public void update(Order bean) {
        String sql = "update tmall.order_ set address= ?, post=?, receiver=?,mobile=?,userMessage=? ,createDate = ? , payDate =? , deliveryDate =?, confirmDate = ? , orderCode =?, uid=?, status=? where id = ?";
        try (Connection c = DBUtil.getConnection(); PreparedStatement ps = c.prepareStatement(sql);) {
    ...
    public List<Order> list(int start, int count) {
        ...
        String sql = "select * from tmall.Order_ order by id desc limit ?,? ";
    ...
    public List<Order> list(int uid, String excludedStatus, int start, int count) {
        ...
        String sql = "select * from tmall.Order_ where uid = ? and status != ? order by id desc limit ?,? ";
